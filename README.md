...
inventory, and dispense product.  All the things that you might expect a vending machine to accomplish.
...
There are three product: cola for $1.00, chips for $0.50, and candy for $0.65.  When the respective button is pressed
